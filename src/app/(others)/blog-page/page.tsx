          ...
          <div className="w-full lg:w-[425px] space-y-6 md:space-y-8">
            ...
            <div className="relative">
              <Input
                ...
                className="w-full h-14 md:h-[70px] pl-6 pr-16 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#FF9F0D] focus:border-transparent placeholder:text-gray-500"
              />
            ...
            <div className="bg-white border border-gray-300 p-4 md:p-6 text-center">
              ...
              <div className="flex justify-center gap-4">
                {[
                  { Icon: FaFacebook, bg: "bg-[#FAF7F2]" },
                  { Icon: FaYoutube, bg: "bg-[#FAF7F2]" },
                  { Icon: FaInstagram, bg: "bg-[#FF9F0D]" },
                  { Icon: SiPixelfed, bg: "bg-[#FAF7F2]" },
                  { Icon: FaTwitter, bg: "bg-[#FAF7F2]" }
                ].map(({ Icon, bg }, index) => (
                  <div key={index} className={`${bg} p-3 cursor-pointer hover:bg-[#FF9F0D] transition-opacity`}>
